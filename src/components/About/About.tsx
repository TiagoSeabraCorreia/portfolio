...
export default function About(){
    const cards: CardData[] = [
        {
            icon:<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none"> <path d="M21 18.6667L25.6667 14L21 9.33337" stroke="white" stroke-width="2.33333" stroke-linecap="round" stroke-linejoin="round"/> <path d="M6.99999 9.33337L2.33333 14L6.99999 18.6667" stroke="white" stroke-width="2.33333" stroke-linecap="round" stroke-linejoin="round"/> <path d="M16.9167 4.66663L11.0833 23.3333" stroke="white" stroke-width="2.33333" stroke-linecap="round" stroke-linejoin="round"/> </svg>,
            ...
            <section className={styles.main}>
                <div className={styles.aboutMe}>
                    <div className={styles.fadeTextContainer}>
                        <span className={styles.fadeText}>About me</span>
                    </div>
                    <div className={styles.longTextContainer}>
                        <span className={styles.longText}>I'm a developer who sees code as a creative medium</span>
                        <span className={styles.longText}>where structure meets fluidity to create experiences that adapt and flow.</span>
                    </div>
                </div>
