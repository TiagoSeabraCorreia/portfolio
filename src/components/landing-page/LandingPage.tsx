        ...
        <div className="
            ...
            >
                <div className="flex flex-col gap-0">
                    <span className="md:text-[96px] sm:text-[96px] sm:leading-[90px] lg:text-[144px] font-inter lg:leading-[130px] font-bold">Teste Finalllllissimoooo!!! SIIIIII RONALDOOOO!!!</span>
